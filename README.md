...
| `onboarding-scope` | Onboarding resources to manage. Use full for workspace, spec, and generated assets, or spec-only for workspace/spec state while leaving existing generated assets unchanged. | no | `full` |
